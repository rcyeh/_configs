...
rsync-get:
	rsync -avub --exclude=".dbus" --exclude=".cache" --exclude=".config" --exclude="log" --exclude=".thumbnails" root@192.168.88.200::NetBackup/r /home/.

rsync-put:
	rsync -avub --exclude=".dbus" --exclude=".cache" --exclude=".config" --exclude="log" --exclude=".thumbnails" /home/r root@192.168.88.200::NetBackup/.

rsync-get-delete:
	rsync -avub --del --exclude=".dbus" --exclude=".cache" --exclude=".config" --exclude="log" --exclude=".thumbnails" root@192.168.88.200::NetBackup/r /home/.

rsync-put-delete:
	rsync -avub --del --exclude=".dbus" --exclude=".cache" --exclude=".config" --exclude="log" --exclude=".thumbnails" /home/r root@192.168.88.200::NetBackup/.
